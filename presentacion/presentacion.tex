...
\begin{frame}{El ngVLA}
    \begin{columns}[T]
        ...
        \begin{column}{0.44\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../informe/images/ngVLA.jpg}\\
            \tiny NRAO/ngVLA
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Secuencia principal y el modelo de Leslie et al.\ (2020)}
    \begin{columns}[T]
        ...
        \begin{column}{0.46\textwidth}
            \centering
            \includegraphics[width=\linewidth]{../informe/images/Secuencia_principal_formacion_estelar.jpg}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Caso 1 -- NGC 3034 (M82): control positivo}
    \centering
    \includegraphics[height=0.72\textheight]{../informe/SINGS/collage/ngc3034.png}\\
...
\begin{frame}{Caso 2 -- NGC 1097: validación del recorte centrado}
    \centering
    \includegraphics[height=0.72\textheight]{../informe/SINGS/collage/ngc1097.png}\\
...
\begin{frame}{Caso 3 -- NGC 4254: validación de flujo positivo}
    \centering
    \includegraphics[height=0.72\textheight]{../informe/SINGS/collage/ngc4254.png}\\
...
\begin{frame}{Banda L: mejora sustancial de detectabilidad en ngVLA-A}
    ...
    \end{center}
    \centering
    \includegraphics[height=0.55\textheight]{../informe/SINGS_1_4GHz/collage/ngc4254.png}\\
