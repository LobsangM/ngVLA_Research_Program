...
# Configuraciones (1.4GHz). VLA-B comentado por ahora: su beam (6.864",
# elongado hasta 24.024" en BMAJ) supera el FOV completo de la imagen
# recortada en todos los z simulados — pendiente de un valor de beam/config
# distinto antes de volver a incluirlo. Ver README/discusión.
CONFIGS = [
    {
        "name":   "ngVLA-A",
...
def make_collage(galaxy):
    ...
    nc = 1 + len(CONFIGS)           # 1 SFR + N telescopios (VLA-B descartado)
