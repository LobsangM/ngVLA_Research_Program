...
# recojan el cambio. Ahora usaremos con ancho de banda de 1.4GHz
NOISE_CONFIG = {
    "ngVLA_A": 62.41,  # nJy/beam (ngECT Subarray: Mid+Spiral+OuterCore; Core descartado, beam > FOV)
    "ngVLA_B": 45.75,  # nJy/beam (ngECT Subarray: Main)
    "VLA_A":   1.99,   # uJy/beam
    "VLA_B":   1.99,   # uJy/beam
}
